...
public class TabbedActivityLogin extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tabbed_activity_login);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_tabbed_activity_login, menu);
        return true;
    }
    ...
    //to switch fragment from fragment
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            // Return a AddItemFragment (defined as a static inner class below).
            switch(position){
                case 0: return SignInFragment.newInstance(position + 1);
